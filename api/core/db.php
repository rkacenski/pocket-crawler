<?php
/*
Shoutout to Rory @ https://github.com/rorystandley/MySQLi-CRUD-PHP-OOP
*/
...
Class Database
{
	 ...
	 * Database class
	 */
	private $db_host = "db.merrimackskiclub.com";  // Change as required
	private $db_user = "skiclub";  // Change as required
	private $db_pass = "squadgoinguponatuesday";  // Change as required
	private $db_name = "owlcrawl";	// Change as required
    ...
    public function escapeString($data){
		if(is_string($data))
			...
			foreach($data as $key => $val)
				$array[$key] = $this->myconn->real_escape_string($val);
			return $array;
		}
    }
}